...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    val mergeBoundaries = new Boundaries
    mergeBoundaries.maxX = a.maxX max b.maxX
    mergeBoundaries.maxY = a.maxY max b.maxY
    mergeBoundaries.minX = a.minX min b.minX
    mergeBoundaries.minY = a.minY min b.minY
    mergeBoundaries
  }
